...
from day01.module import count_increases
...
def test_part_1():
    ...
    Result should be 7
    """
    assert count_increases(TEST_INPUT, 1) == 7
...
def test_part_1_full():
    ...
    """
    assert count_increases(FULL_INPUT, 1) == 1167
...
def test_part_2_full():
    ...
    """
    assert count_increases(FULL_INPUT, 3) == 1130
